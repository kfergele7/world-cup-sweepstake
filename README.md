...
The app currently includes admin authentication, a dashboard, sweepstake creation, public join links, member payment toggles, per-sweepstake team selection, prize setup and ranked pot draw execution.
