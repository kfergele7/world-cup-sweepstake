...
This pass reviewed admin/member permissions, public join behaviour, draw inclusion rules, member locking after draw and the sweepstake admin render path.
...
- Controllers and routes for auth, dashboard, sweepstake management, joining, teams, entrants, prizes and draw execution.
- Basic Blade views plus a small Vue dashboard stats component.
- Tests: `tests/Feature/RunRankedPotDrawTest.php`, `tests/Feature/SweepstakeMemberManagementTest.php`.
...
Current passing test result: 17 tests, 70 assertions.
...
- The admin entrant UI is usable but still basic; a dedicated edit modal or separate entrant page may be nicer later.
